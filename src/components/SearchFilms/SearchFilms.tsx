    ...
    <div className="w-full py-5">
      ...
      <form className="mb-10 flex justify-center md:justify-start">
        <input
          ...
          className={`w-full max-w-[700px] md:w-700 px-4 py-3 rounded-lg bg-white/10 border outline-none ${
            isLight
      ...
      {searchFilms?.results.length === 0 && query !== '' && (
        <p
          className={`text-center md:text-left text-lg opacity-70 ${
